...
public class GameController : Singleton<GameController>
{
    ...
    IEnumerator TimeCountDown()
    {
        ...
        {
            GameUI.Ins.gameDialog.UpdateDialog("New best", "Best killed: " + m_score, "new high score: " + m_score);
        }
        else if (m_score < Prefs.bestScore)
        {
            GameUI.Ins.gameDialog.UpdateDialog("Game over", "your score: " + m_score, "high score: " + Prefs.bestScore);
        }
